# utilities
**v1.0.0 by tomse / Java 25 / Gradle 9.2.0**
## Introduction
...
<br>
<br>Located at: `de.tomse.misc.utilities.async.Countdown`
<br>Example code:
```java
...
<br>
<br>Located at: `de.tomse.misc.utilities.async.Scheduler`
<br>Example code:
...
```java
Scheduler.delayedRepeatingTask(() -> {
    // Do something here
...
<br>
<br>Located at: `de.tomse.misc.utilities.formatter.DateFormatter`
...
<br>
<br>Located at: `de.tomse.misc.utilities.formatter.TimeFormatter`
<br>Example code:
```java
final long timeMillis = 1784719985092L + TimeUnit.DAYS.toMillis(7);
...
<br>
<br>Located at: `de.tomse.misc.utilities.randomizer.ChatRandomizer`
#### Available CharSets
`ALPHA`: Only letters
...
<br>
<br>Located at: `de.tomse.misc.utilities.randomizer.NumberRandomizer`
<br>Example code:
```java
